...
const Calculator = {
	...
	Display_Value: '0',
	//This will hold the operatn for any expressions, we set it to null for now
	First_Operand: null,
	//This checks whether the second operant has been input
...
function Input_Decimal (dot) {
	//This ensures that the accidental clicking of the decimal point
