...
function placeXOrO(squareNumber)	{
	//This condition ensures a square hasn;’t bee determined already.
	//The .some() method is used to check each element of selectedSquare aray to 
	...
	if(!selectedSquares.some(element => element.includes(squareNumber)))	{
		...
		if(activePlayer === 'O')	{
			...
			disableClick();
			//his function waits 1 second before placing the image
			//and enabling click.
...
function disableClick()	{
	...
	function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
		...
		function animateLineDrawing() {
			...
			//This oneition is similar to the one above.
